...
public class CRCStatusType {

    @XmlElement(required = true)
    protected List<CRCStatusType.Condition> condition;
     ...
     * {@link CRCStatusType.Condition }
     * 
     * 
     */
    public List<CRCStatusType.Condition> getCondition() {
        if (condition == null) {
            condition = new ArrayList<CRCStatusType.Condition>();
        }
