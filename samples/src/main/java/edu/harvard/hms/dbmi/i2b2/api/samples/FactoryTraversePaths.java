 ...
 * 
 * java TraversePaths i2b2demo demo demouser http://192.168.56.101:9090/i2b2/services/PMService/getServices Demo 2
 * 
 * @author Jeremy R. Easton-Marks
 *
 */
public class FactoryTraversePaths {
	...
	public static void main(String[] args) {
		if (args.length != 6) {
			...
			System.out
					.println("java TraversePaths domain userName password cellURL project depth");
		}
